                                    ...
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="p-text" type="password" name="pass" placeholder="Password"
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="url-text" type="url" name="url"
                                                    placeholder="https://dummyurl.com" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="mt-1">
                                                <span class="badge badge-primary w-100">
                                                    <small id="sh-text7" class="form-text mt-0 text-left">I am the helper
                                                        text.</small>
                                                </span>
                                            </div>
                                        </div>
