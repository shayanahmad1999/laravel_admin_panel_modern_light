                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="basic-url"
                                        aria-describedby="basic-addon3" placeholder="example.com/users/">
                                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Spinners"
                                        aria-label="spinners" aria-describedby="basic-addon3">
                                </div>

                                <p class="">Right</p>
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" placeholder="Spinners"
                                        aria-label="spinners" aria-describedby="basic-addon4">
                                    <div class="input-group-append">
