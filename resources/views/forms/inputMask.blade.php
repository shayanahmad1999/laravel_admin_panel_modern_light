                    ...
                    <div id="basic" class="col-lg-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="mb-5"><code>&lt;input id="elementId" type="text" class="form-control"
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <small id="isCompleteHelp" class="form-text"
                                        style="display: none; color: #2196f3;">The mask is already filled</small>
                                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <small id="oncompleteHelp" class="form-text"
                                        style="display: none; color: #009688;">You have successfully completed the
                                        mask</small>
                                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <small id="onincompleteHelp" class="form-text"
                                        style="display: none; color: #e2a03f;">Incomplete Input Field</small>
                                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <small id="onclearedHelp" class="form-text"
                                        style="display: none; color: #e7515a;">Plese fill out the field</small>
                                </div>
