                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="card component-card_1">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Mauris nisi felis, placerat in volutpat id, varius et
                                            sapien.</p>
                                    </div>
                                </div>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="card component-card_2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Etiam sed augue ac justo tincidunt posuere. Vivamus
                                            euismod eros, nec risus malesuada.</p>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="card component-card_3">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"> Maecenas nec mi vel lacus condimentum rhoncus
                                            dignissim egestas orci. Integer blandit porta placerat. Vestibulum in
                                            ultricies. </p>
                                    </div>
                                </div>
                                ...
                                <div class="card component-card_4">
                                    <div class="card-body">
                                        ...
                                        <div class="user-info">
                                            ...
                                            <p class="card-text"> Maecenas nec mi vel lacus condimentum rhoncus
                                                dignissim egestas orci. Integer blandit porta placerat. Vestibulum
                                                in ultricies. </p>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <ul class="list-inline badge-collapsed-img mb-0 mb-3">
                                                            ...
                                                            <li class="list-inline-item badge-notify mr-0">
                                                                <div class="notification">
                                                                    <span class="badge badge-info badge-pill">+5
                                                                        more</span>
                                                                </div>
                                                            </li>
                                                        </ul>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="card component-card_9">
                                    <img src="assets/img/400x300.jpg" class="card-img-top" alt="widget-card-2">
                                    <div class="card-body">
                                        <p class="meta-date">25 Jan 2021</p>
